...
######################################################
class ChessboardCalibratorFake(object):
    ...
    def calibrate_fake(self, camera_matrix, camera_distortions):
...
if __name__ == "__main__":
    ...
    ap.add_argument("--image_folder", required=False)
    ...
    initial_guess = np.array([0.135, 0.0, 0.06 , 0, 0.9061391, 0, 0.4229799]) 
    print("initial guess: ", initial_guess)

    cam_K = np.array([[1559.090576171875, 0.0, 957.9228515625], [0.0, 1559.090576171875, 543.37060546875], [0, 0, 1]])
    dist_coeff = np.array([-1.765775442123413, -50.061180114746094, -0.001012681401334703, 0.0006259781657718122, 381.5686340332031])
    ...
    print("Found {} images".format(len(images_files)))
    ...
    calib = ChessboardCalibratorFake(w, h, sqs)
    ...
    rv = calib.calibrate_fake(camera_matrix=cam_K, camera_distortions=dist_coeff)
